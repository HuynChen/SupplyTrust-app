            ...
            <div className="p-6">
              ...
              <div className="space-y-3 mb-6">
                ...
                {product.temperature && (
                  <div className="flex items-center space-x-2 text-sm">
                    ...
                    <span className="text-gray-600">{product.temperature}°C, {product.humidity}% độ ẩm</span>
                  </div>
                )}
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-sm text-green-600">Xác minh bằng blockchain</span>
                </div>
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  {product.certifications.length > 2 && (
                    <span className="inline-flex px-2 py-1 text-xs bg-gray-100 text-gray-600 rounded">
                      +{product.certifications.length - 2} thêm
                    </span>
                  )}
                </div>
              </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <div className="flex items-center space-x-6 text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span>Nhiệt độ: {selectedProduct.temperature}°C</span>
                    </div>
                    <div className="flex items-center space-x-2">
